...
*A dark color theme for [Visual Studio Code](https://code.visualstudio.com), inspired by the moss temple garden in Kyoto.*
...
- **[Kokedera Icons](https://marketplace.visualstudio.com/items?itemName=7th-Layer.kokedera-icons)** — the matching file icon theme
